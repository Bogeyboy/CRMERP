...
class PermissionsDemoSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['guard_name' => 'api', 'name' => 'register_product_categorie']);
        Permission::create(['guard_name' => 'api', 'name' => 'edit_product_categorie']);
        Permission::create(['guard_name' => 'api', 'name' => 'list_product_categorie']);
        Permission::create(['guard_name' => 'api', 'name' => 'delete_product_categorie']);

        Permission::create(['guard_name' => 'api', 'name' => 'register_provider']);
        Permission::create(['guard_name' => 'api', 'name' => 'edit_provider']);
        Permission::create(['guard_name' => 'api', 'name' => 'list_provider']);
        Permission::create(['guard_name' => 'api', 'name' => 'delete_provider']);

        Permission::create(['guard_name' => 'api', 'name' => 'list_wallet_price_product']);
        ...
        Permission::create(['guard_name' => 'api', 'name' => 'list_clientes']);
        ...
        Permission::create(['guard_name' => 'api', 'name' => 'list_proforma']);
        ...
        Permission::create(['guard_name' => 'api', 'name' => 'list_compra']);
        ...
        Permission::create(['guard_name' => 'api', 'name' => 'list_sucursal']);
        Permission::create(['guard_name' => 'api', 'name' => 'edit_sucursal']);
        Permission::create(['guard_name' => 'api', 'name' => 'delete_sucursal']);
        Permission::create(['guard_name' => 'api', 'name' => 'register_sucursal']);

        Permission::create(['guard_name' => 'api', 'name' => 'list_transporte']);
