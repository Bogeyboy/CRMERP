...
export const SIDEBAR:any = [
  ...
  //Permisos sobre proveedores
  {
    ...
    'permisos': [
      {
        name:'Registrar',
        permiso: 'register_provider',
      },
      {
        name:'Editar',
        permiso: 'edit_provider',
      },
      {
        name:'Listar',
        permiso: 'list_provider',
      },
      {
        name:'Eliminar',
        permiso: 'delete_provider',
      }
    ]
  },
  ...
  //Permisos sobre Categorías de producto
  {
    'name': 'Categorías de producto',
    'permisos': [
      {
        name:'Registrar',
        permiso: 'register_product_categorie',
      },
      {
        name:'Editar',
        permiso: 'edit_product_categorie',
      },
      {
        name:'Listar',
        permiso: 'list_product_categorie',
      },
      {
        name:'Eliminar',
        permiso: 'delete_product_categorie',
      }
    ]
  },
